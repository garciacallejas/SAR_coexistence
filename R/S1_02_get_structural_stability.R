...
lambdas <- read.csv2(file = paste("data/posterior_draws/S1_lambda_posterior_draws_",fit.type,".csv",sep=""),header = TRUE,stringsAsFactors = FALSE)
alphas <- read.csv2(file = paste("data/posterior_draws/S1_alpha_posterior_draws_",fit.type,".csv",sep=""),header = TRUE,stringsAsFactors = FALSE)
...
write.csv2(posterior_draws_metrics,file = paste("./results/posterior_draws/S1_posterior_draws_structural_metrics_",base.year,"_",fit.type,".csv",sep=""),row.names = FALSE)
write.csv2(posterior_draws_sproles,file = paste("./results/posterior_draws/S1_posterior_draws_species_roles_",base.year,"_",fit.type,".csv",sep=""),row.names = FALSE)
