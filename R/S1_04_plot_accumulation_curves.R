...
hetrep <- read.csv2("./results/posterior_draws/S1_posterior_draws_accumulation_curves_heterogeneous_both.csv")
homrep <- read.csv2("./results/posterior_draws/S1_posterior_draws_accumulation_curves_heterogeneous_time.csv")
